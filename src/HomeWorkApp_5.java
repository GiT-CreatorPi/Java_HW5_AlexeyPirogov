...
public class HomeWorkApp_5 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < emp.length - 1 ; i++)    //пример заполения массива Иванами Ивановыми
            emp[i] = new Employees();    //Вызов конструктора по умолчанию для иванов ивановых с разным возрастом
        System.out.print("Создан массив из Иванов Ивановых c размерностью " + emp.length + ". ");
        Employees.getCountItem();    //вывод информации количестве объектов в классе с использованием метода класса
        ...
        emp[emp.length - 1] = new Employees("Алексей", "Царь", "Михайлович", 40, "+7(999)666-00-00", "example@work.ru", "Бухгалтерия", "Бухгалтер", 100000);
        ...
        Employees e = new Employees("Гермион", "Ким", "Захарович", 30, "+7(999)666-00-00", "example@work.ru", "МТО", "Специалист", 70000);;    //пример создания экземпляра класса типа Employer
        e.getInfo(true);           //вызов метода объекта для получения информации об объекте
        Employees.getCountItem();        //количество объектов в классе
